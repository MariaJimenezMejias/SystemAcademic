...
public class GrupoController {
    public static void crearGrupo() {
        ...
        System.out.print("Ingrese la cedula del profesor encargado: ");
        ...
        if (idProfesor == -1) {
            System.out.println("Profesor no encontrado con esa cedula.");
            return;
        }
    ...
    public static void listarGrupos() {
        ...
        if (lista.isEmpty()) {
            ...
            for (Grupo g : lista) {
                ...
                System.out.println("Numero Grupo: " + g.getNumeroGrupo());
